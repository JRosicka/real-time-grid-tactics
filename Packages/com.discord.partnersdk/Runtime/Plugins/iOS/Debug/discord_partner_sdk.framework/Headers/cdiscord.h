...
typedef enum Discord_LobbyMemberFlags {
    Discord_LobbyMemberFlags_None = 0,
    Discord_LobbyMemberFlags_CanLinkLobby = 1,
    Discord_LobbyMemberFlags_forceint = 0x7FFFFFFF
} Discord_LobbyMemberFlags;
...
typedef struct Discord_GuildMemberHandle Discord_GuildMemberHandle;
typedef struct Discord_GuildHandle Discord_GuildHandle;
...
typedef void (*Discord_Call_OnStatusChanged)(Discord_Call_Status status,
                                             ...
                                             int32_t errorDetail,
                                             void* userData);
typedef void (*Discord_Client_UpdateLobbyMemberCallback)(Discord_ClientResult* result,
                                                         uint64_t userId,
                                                         uint64_t lobbyId,
                                                         void* userData);
typedef void (*Discord_Client_LobbyActionCallback)(Discord_ClientResult* result,
                                                   uint64_t lobbyId,
                                                   void* userData);
typedef void (*Discord_Client_PerformOnThreadWithStringCallback)(Discord_String text,
                                                                 void* userData);
typedef void (*Discord_Client_UpdateUserApplicationProfileCallback)(Discord_ClientResult* result,
                                                                    void* userData);
...
bool DISCORD_API Discord_ChannelHandle_GetCallInfoHandle(Discord_ChannelHandle* self,
...
struct Discord_GuildMemberHandle {
    void* opaque;
};

void DISCORD_API Discord_GuildMemberHandle_Drop(Discord_GuildMemberHandle* self);
void DISCORD_API Discord_GuildMemberHandle_Clone(Discord_GuildMemberHandle* self,
                                                 Discord_GuildMemberHandle const* other);
bool DISCORD_API Discord_GuildMemberHandle_Avatar(Discord_GuildMemberHandle* self,
                                                  Discord_String* returnValue);
bool DISCORD_API Discord_GuildMemberHandle_AvatarUrl(Discord_GuildMemberHandle* self,
                                                     Discord_String* returnValue);
bool DISCORD_API Discord_GuildMemberHandle_Deaf(Discord_GuildMemberHandle* self);
bool DISCORD_API Discord_GuildMemberHandle_IsGuest(Discord_GuildMemberHandle* self);
bool DISCORD_API Discord_GuildMemberHandle_Mute(Discord_GuildMemberHandle* self);
bool DISCORD_API Discord_GuildMemberHandle_NickName(Discord_GuildMemberHandle* self,
                                                    Discord_String* returnValue);
bool DISCORD_API Discord_GuildMemberHandle_SelfDeaf(Discord_GuildMemberHandle* self);
bool DISCORD_API Discord_GuildMemberHandle_SelfMute(Discord_GuildMemberHandle* self);
struct Discord_GuildHandle {
    void* opaque;
};

void DISCORD_API Discord_GuildHandle_Drop(Discord_GuildHandle* self);
void DISCORD_API Discord_GuildHandle_Clone(Discord_GuildHandle* self,
                                           Discord_GuildHandle const* other);
void DISCORD_API Discord_GuildHandle_ChannelIds(Discord_GuildHandle* self,
                                                Discord_UInt64Span* returnValue);
bool DISCORD_API Discord_GuildHandle_GetGuildMemberHandle(Discord_GuildHandle* self,
                                                          uint64_t userId,
                                                          Discord_GuildMemberHandle* returnValue);
void DISCORD_API Discord_GuildHandle_GuildMemberIds(Discord_GuildHandle* self,
                                                    Discord_UInt64Span* returnValue);
bool DISCORD_API Discord_GuildHandle_IconUrl(Discord_GuildHandle* self,
                                             Discord_String* returnValue);
uint64_t DISCORD_API Discord_GuildHandle_Id(Discord_GuildHandle* self);
void DISCORD_API Discord_GuildHandle_Name(Discord_GuildHandle* self, Discord_String* returnValue);
uint32_t DISCORD_API Discord_GuildHandle_PremiumTier(Discord_GuildHandle* self);
bool DISCORD_API Discord_GuildHandle_Unavailable(Discord_GuildHandle* self);
...
bool DISCORD_API Discord_RelationshipHandle_HasPlayedGame(Discord_RelationshipHandle* self);
...
void DISCORD_API
Discord_Client_AddOrUpdateLobbyMember(Discord_Client* self,
                                      Discord_String token,
                                      uint64_t userId,
                                      uint64_t lobbyId,
                                      Discord_Properties metadata,
                                      Discord_LobbyMemberFlags flags,
                                      Discord_Client_UpdateLobbyMemberCallback callback,
                                      Discord_FreeFn callback__userDataFree,
                                      void* callback__userData,
                                      Discord_String* additionalName);
void DISCORD_API Discord_Client_CreateNewLobby(Discord_Client* self,
                                               Discord_String token,
                                               Discord_Client_LobbyActionCallback callback,
                                               Discord_FreeFn callback__userDataFree,
                                               void* callback__userData);
void DISCORD_API Discord_Client_DeleteLobby(Discord_Client* self,
                                            Discord_String token,
                                            uint64_t lobbyId,
                                            Discord_Client_LobbyActionCallback callback,
                                            Discord_FreeFn callback__userDataFree,
                                            void* callback__userData);
void DISCORD_API Discord_Client_EditLobby(Discord_Client* self,
                                          Discord_String token,
                                          uint64_t lobbyId,
...
void DISCORD_API Discord_Client_ErrorToString(Discord_Client_Error type,
                                              Discord_String* returnValue);
void DISCORD_API Discord_Client_ForceCrash_ForTest(Discord_Client* self);
...
bool DISCORD_API Discord_Client_GetGuildHandle(Discord_Client* self,
                                               uint64_t id,
                                               Discord_GuildHandle* returnValue);
void DISCORD_API Discord_Client_GetGuildIds(Discord_Client* self, Discord_UInt64Span* returnValue);
...
void DISCORD_API Discord_Client_PerformOnThreadWithString_ForTest(
  Discord_Client* self,
  Discord_String text,
  Discord_Client_PerformOnThreadWithStringCallback callback,
  Discord_FreeFn callback__userDataFree,
  void* callback__userData);
void DISCORD_API Discord_Client_RemoveLobbyMember(Discord_Client* self,
                                                  Discord_String token,
                                                  uint64_t userId,
                                                  uint64_t lobbyId,
                                                  Discord_Client_UpdateLobbyMemberCallback callback,
...
void DISCORD_API Discord_Client_ThreadToString(Discord_Client_Thread type,
                                               Discord_String* returnValue);
void DISCORD_API
Discord_Client_UpdateUserApplicationProfile(Discord_Client* self,
                                            Discord_String token,
                                            ...
                                            Discord_Properties metadata,
                                            Discord_Client_UpdateUserApplicationProfileCallback cb,
                                            Discord_FreeFn cb__userDataFree,
                                            void* cb__userData);
...
Discord_Client_GetProvisionalToken(Discord_Client* self,
                                   ...
                                   void* callback__userData);
void DISCORD_API
Discord_Client_GetProvisionalTokenBotAPI(Discord_Client* self,
                                         uint64_t applicationId,
