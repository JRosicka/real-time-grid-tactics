...
namespace Gameplay.Config.Abilities {
    ...
    public class TargetAttackAbilityData : AbilityDataBase<TargetAttackAbilityParameters>, ITargetableAbilityData {
        ...
        protected override AbilityLegality AbilityLegalImpl(TargetAttackAbilityParameters parameters, GridEntity entity, GameTeam team, out string failureReason) {
            failureReason = null;
        ...
        public void DoTargetableAbility(Vector2Int cellPosition, GridEntity selectedEntity, GameTeam selectorTeam, System.Object targetData) {
            ...
            if (target != null && (target.Team == selectedEntity.Team || (target.Team == GameTeam.Neutral && !target.EntityData.Attackable))) {
            ...
            selectedEntity.SetTargetLocation(cellPosition, target, PathVisualizer.PathType.TargetAttack);
        }
