...
namespace Gameplay.Entities {
    ...
    public class GridEntity : NetworkBehaviour {
        ...
        public void MoveToCell(Vector2Int targetCell) {
            ...
            PerformAbility(data, new MoveAbilityParameters { Destination = targetCell, SelectorTeam = MyTeam});
        }
        ...
        public void TryTargetEntity(GridEntity targetEntity, Vector2Int targetCell) {
            ...
            if (targetType == TargetType.Enemy) {
                ...
                PerformAbility(data, new AttackAbilityParameters { Target = targetEntity, Attacker = this });
            }
        }
        ...
        public bool PerformAbility(IAbility ability) {
            ...
            GameManager.Instance.CommandManager.PerformAbility(ability);
            return true;
        }
        ...
        private void PerformOnStartAbilities() {
            foreach (IAbilityData abilityData in Abilities.Select(a => a.Content).Where(a => a.PerformOnStart)) {
                PerformAbility(abilityData, new NullAbilityParameters());
            }
        }
